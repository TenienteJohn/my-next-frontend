...
export async function PUT(
  ...
  try {
    ...
    const url = `${apiBaseUrl}/api/options/${params.id}`;
    ...
    console.error(`Proxy /options/${params.id} (PUT): Error en la solicitud`, error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error(`Proxy /options/${params.id} (DELETE): Error en la solicitud`, error);
