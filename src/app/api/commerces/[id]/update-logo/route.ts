// src/app/api/commerces/[id]/update-logo/route.ts
...
export async function PUT(
  ...
  try {
    ...
    const url = `${apiBaseUrl}/api/commerces/${id}/update-logo`;
    ...
    console.log(`Proxy /commerces/${id}/update-logo (PUT): Enviando solicitud al backend`, {
      id,
    ...
    try {
      ...
      try {
        ...
        if (response.ok) {
          data = {
            ...
            logo_url: `/images/commerces/${id}_logo.jpg`  // URL de fallback genérica
          };
        } else {
      ...
      console.log(`Proxy /commerces/${id}/update-logo (PUT): Respuesta del backend recibida`, {
    ...
    console.error(`Proxy /commerces/${id}/update-logo (PUT): Error en la solicitud`, error);
