...
export async function PUT(
  ...
  try {
    ...
    const url = `${apiBaseUrl}/api/items/${params.id}`;
    ...
    console.error(`Proxy /items/${params.id} (PUT): Error en la solicitud`, error);
...
export async function DELETE(
  ...
  try {
    ...
    console.error(`Proxy /items/${params.id} (DELETE): Error en la solicitud`, error);
    const errorMessage = error instanceof Error
      ? error.message
      : 'Error desconocido';
    return NextResponse.json(
