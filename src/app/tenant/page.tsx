...
export default function TenantLandingPage() {
  // Estado para controlar la vista actual (productos, checkout, confirmación)
...
// Funciones para manejar el carrito
  ...
  // MODIFICADO: Función de checkout ahora cambia a la vista de checkout
  const handleCheckout = () => {
    setIsCartOpen(false); // Cerrar el carrito
    setCurrentView('checkout'); // Cambiar a la vista de checkout
  ...
  // NUEVO: Función para completar la compra
  const handleCompletePurchase = (orderData: any) => {
    console.log('Orden completada:', orderData);
    setCompletedOrder(orderData);
    setCurrentView('confirmation');
    setCartItems([]); // Vaciar el carrito al completar la compra
  };

  // NUEVO: Función para volver a la tienda desde la confirmación
  ...
  // MODIFICADO: Renderizar diferentes vistas según el estado actual
  ...
  // Vista de productos (vista principal)
  return (
