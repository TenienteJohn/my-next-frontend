      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        >
          ...
          <div className="flex items-center bg-white p-3 rounded-lg text-green-800 text-sm">
            ...
            <p>Te enviaremos una confirmación por WhatsApp</p>
          </div>
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-1.5">
                      <p className="text-gray-700 flex items-center">
                        ...
                        Tiempo estimado: <span className="font-medium ml-1">
                          {/* Usar el tiempo de entrega desde la base de datos */}
                          {order.commerce?.delivery_time || "30-60 minutos"}
                        </span>
                      </p>
        ...
        {/* Información del cliente - Eliminado el campo de email */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            onClick={() => {
              // Si tenemos una función de retorno proporcionada como prop, la usamos primero
              if (onGoBack) {
                onGoBack();
              } else {
                // Intenta usar la historia del navegador si existe
                router.back();
              }
            }}
